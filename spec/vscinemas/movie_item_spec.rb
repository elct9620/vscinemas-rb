...
RSpec.describe VSCinemas::MovieItem do
  let(:element) { Nokogiri::HTML(File.read(Bundler.root.join('spec/fixtures/vscinemas/movie.html'))) }
  ...
  describe '#to_h' do
    ...
    it {
      is_expected.to include(figure: URI.join(VSCinemas::ENDPOINT, VSCinemas::PATH,
                                              '../upload/film/film_20201106001.jpg'))
    }
  end
end
